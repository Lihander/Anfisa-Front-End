<template>
  <div class="buttons-list">
    <AppButton class="buttons-list__button" btnClass="btnSecondary" @click="showVariantsList">
    ...
    <div class="view-btn-wrapper">
      ...
      <div v-show="showViewSwitcher" class="view-wrapper">
        <DefaultSwitcher @selected="viewChange" :items="viewItems" :hideName="true"/>
      </div>
    </div>
    <AppButton class="buttons-list__button" btnClass="btnDefault" @click="showVariantsList">
  ...
  export default {
    ...
    computed: {
      getVariantsListButtonIcon() {
        return this.isVariantsListShow ? this.hideVariantsListButtonIcon : this.showVariantsListButtonIcon
      }
    },
    methods: {
      showVariantsList() {
      ...
      viewChange(selectedItem) {
        ...
        this.$router.push({ path: '/' + selectedItem.view, query: { ws: selectedWorkspace } })
      },
      hideViewSwitcher() {
        setTimeout(() => {this.showViewSwitcher = false}, 300)
      }
    }
  }
</script>
